      ...
      <div className="mx-auto w-full max-w-7xl px-4 md:px-8">
        ...
        <div className="flex items-center justify-between py-3 md:py-4">
          ...
          <nav className="hidden items-center gap-6 text-sm font-semibold md:flex">
            <a href="#portafolio" className="transition-colors hover:text-[#f97316]">
              Portfólio
            </a>
            <a href="#empresa" className="transition-colors hover:text-[#f97316]">
              Empresa
            </a>
            <a href="#contacto" className="transition-colors hover:text-[#f97316]">
              Contato
            </a>
          </nav>
        </div>
